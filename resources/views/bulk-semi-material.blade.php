...
@section('title', 'Bulk Semi Finished Material Upload')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            ...
            <form action="{{ route('semi.bulkStore') }}" method="post" autocomplete="off" enctype="multipart/form-data">
            @csrf
            <div class="card mt-3">
                <div class="card-header">
                    <h3 class="card-title">Bulk Semi Finished Material Upload</h3>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer text-right">
                    <a href="{{ asset('assets/formats/bulk-semi-material.xlsx') }}" type="button" class="btn btn-outline-success"><i class="fas fa-file-export"></i> Download Format</a>
                    <a href="{{ route('semi') }}" class="btn btn-outline-danger"><i class="fas fa-times"></i> Cancel</a>
