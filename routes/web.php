...
Route::middleware(['auth', 'checkStatus'])->group(function () {
    ...
    Route::prefix('/app/bill-of-materials')->group(function () {
        ...
        Route::post('/bom-cost-summary', [BOMController::class, 'fetchFgCostSummary'])->name('bom.fetchFgCostSummary');
    });
    ...
    Route::prefix('/app/users')->group(function () {
        ...
        Route::get('/{user}/permission', [UserController::class, 'permission'])->name('users.permission');
        Route::post('/{user}/permission', [UserController::class, 'setPermission'])->name('users.setPermission');
    ...
    Route::prefix('/app/reports')->group(function () {
        ...
        Route::get('/fg-cost-summary', [BOMController::class, 'fgCostSummary'])->name('reports.fgCostSummary');
